...
In addition to the core workflow, the demo includes simulated attacker actions that illustrate the security benefits:
...
- **Final Summary** – compares traditional SSH exposure versus the ZTLP‑protected setup with statistics from the simulated attacks.
