defmodule ZtlpNs.ReleaseTest do
  ...
  describe "version reporting (regression pin)" do
    ...
    test "mix.exs version is at least 0.30.3 (v0.30.3 Z2LS gateway-auth tag)" do
      ...
      # misreport itself as one of the pre-v0.30.3 versions. Ratcheted from
      # 0.29.4 → 0.30.3 in PR release/v0.30.3 after the v0.30.3 tag was cut
      # from a5993ee (PR #40 — Z2LS gateway-auth enrollment API). Using
      ...
      # only fails on a down-bump below the 0.30.3 floor.
      declared = ZtlpNs.MixProject.project()[:version]
